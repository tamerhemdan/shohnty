...
$('.mapCardCloss').click(function(){  //for search boox clos
  $('.all-map-text').hide(500);
  
});


  $(".truck").click(function(){          //for chsng image calculat type
    $(".small-image").attr("src", "img/col.jpg");
  });
  $(".air").click(function(){            //for chsng image calculat type
    $(".small-image").attr("src", "img/air.jpg");
  });
   $(".ocen").click(function(){          //for chsng image calculat type
    $(".small-image").attr("src", "img/ocen.jpg");
  });
  $(".shuter-stock").click(function(){   //for chsng image calculat type
...
$('.datepicker').datepicker({ //for date picker calinder
    format: 'mm/dd/yyyy',
    startDate: '-3d'
});
